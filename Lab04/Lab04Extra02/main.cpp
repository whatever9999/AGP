...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch (message)
	{
		case WM_CHAR:
			...
			{
				case 'w':
					g_cb0_values.PosChange.y += 1;
					break;
				case 's':
					g_cb0_values.PosChange.y -= 1;
					break;
				case 'a':
					g_cb0_values.PosChange.x -= 1;
					break;
				case 'd':
					g_cb0_values.PosChange.x += 1;
					break;
				case 'z':
					g_cb0_values.Scale -= 0.1;
					break;
				case 'x':
					g_cb0_values.Scale += 0.1;
					break;
				case '1':
					g_cb0_values.Choice = 1;
					break;
				case '2':
					g_cb0_values.Choice = 2;
					break;
				case '3':
					g_cb0_values.Choice = 3;
					break;
				case '4':
					g_cb0_values.Choice = 4;
					break;
			}
...
HRESULT InitialiseGraphics()
{
	...
	constant_buffer_desc.ByteWidth = 96;
	constant_buffer_desc.BindFlags = D3D11_BIND_CONSTANT_BUFFER;
	hr = g_pD3DDevice->CreateBuffer(&constant_buffer_desc, NULL, &g_pConstantBuffer0);

	// Attach cb0_values
	g_cb0_values.Scale = 1;
	g_cb0_values.Choice = 1;
	g_cb0_values.Colour_1 = XMFLOAT4(0.1f, 0.1f, 0.1f, 1.0f);
	g_cb0_values.Colour_2 = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	g_cb0_values.Colour_3 = XMFLOAT4(0.2f, 0.4f, 0.6f, 1.0f);
	g_cb0_values.Colour_4 = XMFLOAT4(0.8f, 0.0f, 0.8f, 1.0f);
	g_pImmediateContext->UpdateSubresource(g_pConstantBuffer0, 0, 0, &g_cb0_values, 0, 0);
