...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
		case WM_LBUTTONDOWN:
			g_degrees = static_cast<float>(rand()) / static_cast<float>(RAND_MAX) * 360;
...
HRESULT InitialiseGraphics()
{
	...
	{
		{XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT4(0.4f, 0.1f, 0.1f, 1.0f)},
		{XMFLOAT3(1.0f, 0.0f, 0.0f), XMFLOAT4(0.9f, 0.5f, 0.5f, 1.0f)},
		{XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT4(0.7f, 0.3f, 0.3f, 1.0f)},
		{XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT4(0.4f, 0.1f, 0.1f, 1.0f)},
		{XMFLOAT3(1.0f, 1.0f, 0.0f), XMFLOAT4(0.9f, 0.5f, 0.5f, 1.0f)},
		{XMFLOAT3(1.0f, 0.0f, 0.0f), XMFLOAT4(0.7f, 0.3f, 0.3f, 1.0f)},
		{XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT4(0.4f, 0.1f, 0.1f, 1.0f)},
		{XMFLOAT3(0.5f, 0.5f, 1.0f), XMFLOAT4(0.9f, 0.5f, 0.5f, 1.0f)},
		{XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT4(0.7f, 0.3f, 0.3f, 1.0f)},
		{XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT4(0.4f, 0.1f, 0.1f, 1.0f)},
		{XMFLOAT3(0.5f, 0.5f, 1.0f), XMFLOAT4(0.9f, 0.5f, 0.5f, 1.0f)},
		{XMFLOAT3(1.0f, 1.0f, 0.0f), XMFLOAT4(0.7f, 0.3f, 0.3f, 1.0f)},
		{XMFLOAT3(1.0f, 1.0f, 0.0f), XMFLOAT4(0.4f, 0.1f, 0.1f, 1.0f)},
		{XMFLOAT3(0.5f, 0.5f, 1.0f), XMFLOAT4(0.9f, 0.5f, 0.5f, 1.0f)},
		{XMFLOAT3(1.0f, 0.0f, 0.0f), XMFLOAT4(0.7f, 0.3f, 0.3f, 1.0f)},
		{XMFLOAT3(1.0f, 0.0f, 0.0f), XMFLOAT4(0.4f, 0.1f, 0.1f, 1.0f)},
		{XMFLOAT3(0.5f, 0.5f, 1.0f), XMFLOAT4(0.9f, 0.5f, 0.5f, 1.0f)},
		{XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT4(0.7f, 0.3f, 0.3f, 1.0f)},
	};
	...
	bufferDesc.ByteWidth = sizeof(POS_COL_VERTEX) * numVertices;
