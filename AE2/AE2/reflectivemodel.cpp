...
HRESULT ReflectiveModel::Setup()
{
	...
	D3D11_BUFFER_DESC constant_pixel__buffer_desc;
	ZeroMemory(&constant_pixel__buffer_desc, sizeof(constant_pixel__buffer_desc));
	constant_pixel__buffer_desc.Usage = D3D11_USAGE_DEFAULT;
	constant_pixel__buffer_desc.ByteWidth = 96;
	constant_pixel__buffer_desc.BindFlags = D3D11_BIND_CONSTANT_BUFFER;
	hr = m_D3DDevice->CreateBuffer(&constant_pixel__buffer_desc, NULL, &m_pPixelConstantBuffer);
